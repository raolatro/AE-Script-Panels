    ...
    function TrimPathsAnimator(thisObj) {
        ...
        function animate() {
            ...
            for (var i = 0; i < layers.length; i++) {
                ...
                // Add Trim Paths and Expressions
        ...
        function addTrimPathsAndExpressions(layer, easeValue, offsetValue) {
            ...
            // Search for existing Trim Paths named "Trim Path (Dynamic Rao)"
            for (var i = 1; i <= contents.numProperties; i++) {
                var prop = contents.property(i);
                if (prop.matchName === "ADBE Vector Filter - Trim" && prop.name === "Trim Path (Dynamic Rao)") {
                    trimPathsGroup = prop;
                    break;
                }
            }
            ...
            if (!trimPathsGroup) {
                ...
                // Move to bottom
                trimPathsGroup.moveTo(contents.numProperties);
            } else {
            ...
            if (!easeEffect) {
                ...
                easeEffect.property("ADBE Slider Control-0001").setValue(easeValue);
            } else {
                easeEffect.property("ADBE Slider Control-0001").setValue(easeValue);
            }
            ...
            var startExpr =
                ...
                "var startValue = 100;\n" +
                "var easePercent = effect(\"Ease\")(\"ADBE Slider Control-0001\") / 100;\n" +
